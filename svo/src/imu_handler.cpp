...
bool ImuHandler::getMeasurementsContainingEdges(
    ...
    ImuMeasurements& extracted_measurements, const bool remove_measurements) {
    ...
    if (remove_measurements) {
        ...
        // it+1, the first frame with smaller timestamp (earlier) than
        // frame_timestamp, which will be used in interpolation in next
        // iteration
