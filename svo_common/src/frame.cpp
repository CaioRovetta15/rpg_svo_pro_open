...
Frame::Frame(const CameraPtr& cam, const cv::Mat& img,
...
bool getSceneDepth(const FramePtr& frame, double& depth_median,
...
void computeNormalizedBearingVectors(const Keypoints& px_vec, const Camera& cam,
                                     Bearings* f_vec) {
    CHECK_NOTNULL(f_vec);
